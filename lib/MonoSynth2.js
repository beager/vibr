...
MonoSynth = function (audioContext){
  ...
  this.envelope = new Float32Array([0.0,0.0,0.02,0.0]);
  ...
  var request = new XMLHttpRequest();
    request.open("GET", './ir/cardiod-true-stereo-15-8.wav', true);
...
MonoSynth.prototype.setOscillator = function(osc) {
  this.oscillator.type = osc;
}

MonoSynth.prototype.noteOn = function(note, velocity){

  //get frequency value by note ex:'C#5' = 554.37 Hertz
  var frequency = this.notes[note] || note || 0,
